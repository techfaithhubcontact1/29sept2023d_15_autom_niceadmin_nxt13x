        ...
        <aside id="sidebar" className="sidebar">
            <ul className="sidebar-nav" id="sidebar-nav">
                ...
                <li className="nav-item">
                    ...
                    <li>
                        <Link href="/NiceAdmin/components-alerts">
                        <i className="bi bi-circle" /><span>Alerts</span>
                        </Link>
                    </li>
                    <li>
                        <Link href="/NiceAdmin/components-accordion">
                        <i className="bi bi-circle" /><span>Accordion</span>
                        </Link>
                    </li>
                    <li>
                        <Link href="/NiceAdmin/components-badges">
                        <i className="bi bi-circle" /><span>Badges</span>
                        </Link>
                    </li>
                    <li>
                        <Link href="/NiceAdmin/components-buttons">
